...
! CE3TSK: these first-call tables were one shared copy for all decoder threads; a thread could
! read a table another thread was still filling, so the earliest subtractions varied by timing
