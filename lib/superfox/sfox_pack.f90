...
! CE3TSK: from WSJT-X 3.0.2 lib/superfox/sfox_pack.f90, used here only by the test tool
! sfoxsim (jtdx does not transmit SuperFox). One change: jtdx's pack28 takes a third argument,
! 0 = do not enter the call in the TX hash table.
...
! Split the command line into words
  ...
  call pack28(w(1),n28,0)                      !Fox call
