...
subroutine hintrxgrid9(mrs,mrs2,mycall,decoded,hintdec,s3,i4GrayCodedSym)
...
! a bank of matched filters on the symbol spectra s3(i,j).
  ...
  if((qual.ge.0.67 .or. u1.ge.0.75) .and. thresh.gt.11.65) then
!print *,qual,u1
!print *,thresh
     decoded=msg0(ipk)
     hintdec=.true.
